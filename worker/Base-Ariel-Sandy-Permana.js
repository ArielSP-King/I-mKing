...
break
case prefix+'ytmp3': {
if (!args[0]) return ads('Contoh : #ytmp3 https://youtube.com/kontol.mp4')
ads(mess.wait)
try {
hx.youtube(args[0]).then(async(apaantuh) => {
sock.sendMessage(from, { audio: { url: apaantuh.mp3 }, mimetype: 'audio/mp4' }, { quoted: m })
}).catch(_ => _)
} catch {
ads("Linknya Error!")
}
...
break
case prefix+'ytmp4': {
if (!args[0]) return ads('Contoh : #ytmp4 https://youtube.com/kontol.mp4')
ads(mess.wait)
try {
hx.youtube(args[0]).then(async(apaantuhbang) => {
sock.sendMessage(from, { video: { url: apaantuhbang.link }, caption: "Done Kak" }, { quoted: m })
}).catch(_ => _)
} catch {
ads("Linknya Error!")
}
