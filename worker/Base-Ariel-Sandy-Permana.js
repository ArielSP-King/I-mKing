...
case prefix+'ytmp3': case prefix+'ytaudio': {
                ...
                sock.sendMessage(from, { audio: { url: arielkontolodon.mp3 }, mimetype: 'audio/mp4' }, { quoted: m })
            }
            addCmd(command.slice(1), 1, commund)
            break
            case prefix+'ytmp4': case prefix+'ytvideo': {
                ...
                sock.sendMessage(m.chat, { video: { url: arielkontolodon1.mp4 }, mimetype: 'video/mp4', fileName: `ArielSP.mp4`, caption: `Done Bang` }, { quoted: m })
            }
            addCmd(command.slice(1), 1, commund)
            break
