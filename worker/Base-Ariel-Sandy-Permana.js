...
case prefix+'ytmp3': case prefix+'ytaudio': {
                sock.sendMessage(from, { audio: { url: `https://api.dev-rfz.repl.co/api/youtube/downloader?link=${args.join(" ")}` }, mimetype: 'audio/mp4' }, { quoted: m })
            }
            addCmd(command.slice(1), 1, commund)
            break
            case prefix+'ytmp4': case prefix+'ytvideo': {
                sock.sendMessage(m.chat, { video: { url: `https://api.dev-rfz.repl.co/api/youtube-v2/downloader?link=${args.join(" ")}` }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `Done Bang` }, { quoted: m })
            }
            addCmd(command.slice(1), 1, commund)
            break
